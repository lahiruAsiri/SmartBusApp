...
// Service for managing rewards, achievements, and leaderboard with dummy data
...
// Service functions
export const getDriverRewardData = (): Promise<DriverRewardData> => {
  return new Promise((resolve) => {
    setTimeout(() => resolve(DUMMY_DRIVER_DATA), 500);
  });
};
